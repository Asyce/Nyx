    ...
    TimeProvider timeProvider)
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        json.WritePropertyName(archive.Game.GameId == "gi" ? "hk4e" : "hkrpg");
...
public static class WindowsDownloadsDirectory
{
    ...
    public static string Get()
    {
        if (OperatingSystem.IsWindows())
        {
            ...
            try
            {
                if (SHGetKnownFolderPath(DownloadsFolder, 0, 0, out pointer) == 0 && pointer != 0)
                {
            ...
            throw new InvalidOperationException("The Windows Downloads known folder is unavailable.");
        }
