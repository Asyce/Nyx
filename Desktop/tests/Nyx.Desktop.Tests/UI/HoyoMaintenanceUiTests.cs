...
public sealed class HoyoMaintenanceUiTests
{
    ...
    {
        var page = ReadAppFile("MainPage.xaml.cs");
        var projector = ReadCoreFile(
            "PublisherMaintenance",
            "HoyoPublisherMaintenanceLabelProjector.cs");

        Assert.Contains("HoyoPublisherMaintenanceLabelProjector.Project", page, StringComparison.Ordinal);
        Assert.Contains("status.Update is PublisherUpdateState.Unknown", projector, StringComparison.Ordinal);
        Assert.Contains("Update + pre-download available", projector, StringComparison.Ordinal);
        Assert.Contains("Update available", projector, StringComparison.Ordinal);
        Assert.Contains("Pre-download available", projector, StringComparison.Ordinal);
        Assert.Contains("Up to date", projector, StringComparison.Ordinal);
        Assert.Contains("Check in HoYoPlay", projector, StringComparison.Ordinal);
