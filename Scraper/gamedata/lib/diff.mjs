// GameData diff helpers. Hashing/canonicalization lives in ../../lib/common.mjs
// (single source of truth); this module only pins the GameData-specific omit set
...
const GAMEDATA_OMIT_KEYS = new Set(['contentStatus', 'liveComparison', 'scrapedAt', 'sourceSnapshot']);

export function contentHash(value, omitKeys = GAMEDATA_OMIT_KEYS) {
