...
public sealed class EndfieldMaintenanceUiTests
{
    ...
    public void Manual_folder_picker_validates_before_saving_and_maintenance_remains_separate()
    {
        ...
        Assert.True(
            maintenance.IndexOf("ChooseGameFolderButton.IsEnabled = false", StringComparison.Ordinal)
            < maintenance.IndexOf("endfieldMaintenance.OpenOrObserveCurrentAsync", StringComparison.Ordinal));
    }
