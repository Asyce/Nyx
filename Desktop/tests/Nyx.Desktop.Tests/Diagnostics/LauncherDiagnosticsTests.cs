...
{
    [Fact]
    public void Feature_flags_are_independent_and_future_lanes_default_off()
    {
        ...
        Assert.False(defaults.IsEnabled(LauncherFeatureFlag.ZzzPulls));

        var changed = defaults.Set(LauncherFeatureFlag.GiPulls, false);
