...
const outDir = path.resolve(dbDir, 'Nanoka', 'gi', 'furniture');
...
if (!listPayload) throw new Error('Could not find Nanoka furniture list payload in page HTML.');
if (!staticBase) throw new Error('Could not determine Nanoka furniture static API base URL.');
