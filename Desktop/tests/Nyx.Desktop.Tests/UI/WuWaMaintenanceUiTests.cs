...
public sealed class WuWaMaintenanceUiTests
{
    ...
    public void WuWa_direct_session_and_official_maintenance_stay_separate()
    {
        ...
        Assert.DoesNotContain("gameId is not (\"gi\" or \"hsr\" or \"zzz\")", page, StringComparison.Ordinal);
    }
    ...
    public void Open_official_is_visible_only_for_ready_or_exact_running_WuWa_state()
    {
        ...
        Assert.Contains("Official maintenance needs review", render, StringComparison.Ordinal);
    ...
    public void Only_explicit_click_dispatches_the_stored_request_and_suppresses_repeats()
    {
        ...
        Assert.Contains("Official launcher start requested", page, StringComparison.Ordinal);
